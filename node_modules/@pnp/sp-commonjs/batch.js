...
var SPBatch = /** @class */ (function (_super) {
    (0, tslib_1.__extends)(SPBatch, _super);
            ...
            return (0, tslib_1.__generator)(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        client = new sphttpclient_js_1.SPHttpClient(this.runtime);
                        return [4 /*yield*/, (0, toabsoluteurl_js_1.toAbsoluteUrl)(this.url, this.runtime)];
                    case 1:
                        ...
                        for (i = 0; i < this.requests.length; i++) {
                            ...
                            if (reqInfo.method === "GET") {
                                ...
                                if (currentChangeSetId.length < 1) {
                                    ...
                                    currentChangeSetId = (0, common_1.getGUID)();
                                    batchBody.push("--batch_" + this.batchId + "\n");
                            ...
                            headers = new Headers();
                            url = (0, common_1.isUrlAbsolute)(reqInfo.url) ? reqInfo.url : (0, common_1.combine)(absoluteRequestUrl, reqInfo.url);
                            logging_1.Logger.write("[" + this.batchId + "] (" + (new Date()).getTime() + ") Adding request " + reqInfo.method + " " + url + " to batch.", 0 /* Verbose */);
                            if (reqInfo.method !== "GET") {
                                method = reqInfo.method;
                                castHeaders = reqInfo.options.headers;
                                if ((0, common_1.hOP)(reqInfo, "options") && (0, common_1.hOP)(reqInfo.options, "headers") && castHeaders["X-HTTP-Method"] !== undefined) {
                            ...
                            (0, common_1.mergeHeaders)(headers, (_a = this.runtime.get("sp")) === null || _a === void 0 ? void 0 : _a.headers);
                            // merge per-request headers
                            if (reqInfo.options) {
                                (0, common_1.mergeHeaders)(headers, reqInfo.options.headers);
                            }
                        ...
                        logging_1.Logger.write("[" + this.batchId + "] (" + (new Date()).getTime() + ") Sending batch request.", 1 /* Info */);
                        return [4 /*yield*/, client.fetch((0, common_1.combine)(absoluteRequestUrl, "/_api/$batch"), batchOptions)];
                    case 2:
                        fetchResponse = _b.sent();
                        if (!!fetchResponse.ok) return [3 /*break*/, 4];
                        return [4 /*yield*/, odata_1.HttpRequestError.init(fetchResponse)];
                    case 3: 
                    ...
                    case 5:
                        ...
                        logging_1.Logger.write("[" + this.batchId + "] (" + (new Date()).getTime() + ") Resolving batched requests.", 1 /* Info */);
                        ...
                        return [2 /*return*/, responses.reduce(function (p, response, index) { return p.then(function () { return (0, tslib_1.__awaiter)(_this, void 0, void 0, function () {
                                var request, _a, _b, e_1;
                                return (0, tslib_1.__generator)(this, function (_c) {
                                    switch (_c.label) {
                                        case 0:
                                            request = this.requests[index];
                                            logging_1.Logger.write("[" + request.id + "] (" + (new Date()).getTime() + ") Resolving request in batch " + this.batchId + ".", 1 /* Info */);
                                            _c.label = 1;
                                        case 1:
                                            _c.trys.push([1, 3, , 4]);
